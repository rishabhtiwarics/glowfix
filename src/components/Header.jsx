...
export default function Header() {
  ...
  return (
    <>
      {/* ── Main header bar ── */}
      <header
        className={`absolute inset-x-0 top-0 z-30 transition-[background-color,backdrop-filter,box-shadow] duration-300 ease-out ${scrolled
          ...
          <div className="px-4 pb-6 pt-5">
            ...
            <div
              className={`overflow-hidden transition-[max-height,opacity] duration-300 ease-out ${
                categoriesOpen ? "max-h-[292px] opacity-100" : "max-h-0 opacity-0"
              }`}
            >
